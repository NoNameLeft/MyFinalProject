    ...
    public class ManufacturersSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.PAMPManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.ScottsdaleManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.PerthMintManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.RoyalMintManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.HeraeusManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.UmicoreManufacturerName).Id,
            ...
            await dbContext.Manufacturers.AddAsync(new Manufacturer
            {
                ...
                CountryId = dbContext.Countries.FirstOrDefault(x => x.Name == "Switzerland").Id,
                LogoId = dbContext.Images.FirstOrDefault(x => x.Name == GlobalConstants.MetalorManufacturerName).Id,
